...
\label{tabl:Table1}
\textit{Two sample t-tests of the difference in mean calls per SATC per distance group.}
...
\label{fig:Table2}
\textit{Two sample t-tests of the difference in mean crime only calls per SATC per distance group.}
\textit{Distances in kilometers squared.}
\end{table}
