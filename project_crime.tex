...
We conducted a set paired t-test to examine the statistical likelihood that one distance ring has a greater mean number of calls than the next larger ring. The pairwise comparison table is seen in \Table 1.
