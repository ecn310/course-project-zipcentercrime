...
\label{tab:Table1}
 \begin{minipage}{1\linewidth}
        \centering
        \textit{Mean 1 is the mean calls of the lower bound distance ring.} \\
        \textit{Mean 2 is the mean calls of the higher bound distance ring.}
    \end{minipage}
\end{table}
...
\begin{figure}{h!}
    \centering
    \includegraphics[width=0.5\linewidth]{CI_Graph.png}
