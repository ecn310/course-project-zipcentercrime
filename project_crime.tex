...
\section{Results}
\label{sec:result}
\subsubsection{Summary Statisticsw}
...
\begin{itemize}
    ...
    \item Couldn't fine tune 911 call data to account for if a 911 call was drug related or not. Without more data avaible, like drug tests done, can't account if drugs had a part of play the actions of individual comitting crime (If the crime was violent related at all). 
