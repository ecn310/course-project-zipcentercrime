...
Our hypothesis was as the distance from a substance abuse treatment cener (SATC) increases, the frequency of 911 calls increase. The closer a SATC is, the more accessible treatments for drug abuse are, which should reduce crime rates in the area, measured by 911 calls. We conducted cross-sectional analysis to examine the overlap of 911 calls geographical locations to their distances to their closest SATC. Our results show that contrast to our hypothesis, as distance from a SATC increases, the amount of 911 calls decreased. 
