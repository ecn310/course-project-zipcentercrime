...
\section{Introduction} \label{sec:introduction}
  A common concern among the general American public is that crime rates are increasing. About 6 in 10 Americans share this concern according to Pew Research Center. Additionally, drug usage is another public concern in the American populous, especially in urban centers. This paper seeks to answer this question by exploring the correlation between proximity to treatment facilities and the frequency of emergency calls. Our hypothesis theorizes that a closer proximity to drug treatment centers increases access to drug rehabilitation and mental health resources, which, in turn, decreases drug usage. This reduction in drug usage would theoretically lead to a decrease in drug-related crimes and, consequently, fewer calls to 911. So, we explored the question, "How does the distance to the closest drug rehabilitation center relate to the number of calls to 911?" It is very in line with what \cite{mental_healthcare_and_crime} has stated what happens in areas where drug usage is lowered.
...
\label{sec:conclusion}
   ...
   % Although the literature on the relationship of crime and substance abuse treatment centers is limited, these findings 
