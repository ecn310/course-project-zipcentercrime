...
Our hypothesis was as the distance from a substance abuse treatment cenet (SATC) increases, the frequency of 911 calls increase. The closer a SATC is, the more accessible treatments for drug abuse are, which should reduce crime rates in the area, measured by 911 calls. We used data from Detroit's Police Department Crime Data Analytics and from N-SSATS to due cross-sectional analysis on the overlap of 911 calls geographical locations to their distance with SATC. Our results show that 
