...
\subsubsection{Stata}
  \item Open that dataset into Stata and follow this do file "\href{https://github.com/ecn310/course-project-zipcentercrime/blob/main/ArcGIS%20files/ArcDataDo.do}{ArcData Do File}"
