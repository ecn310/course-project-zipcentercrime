...
graph bar CallxArea, over(dist_group)
...
eststo clear
eststo: ratio dist_group_100/dist_group_250
eststo: ratio dist_group_250/dist_group_500
eststo: ratio dist_group_500/dist_group_750
eststo: ratio dist_group_750/dist_group_1000
eststo: ratio dist_group_1000/dist_group_1250
eststo: ratio dist_group_1250/dist_group_1500
eststo: ratio dist_group_1500/dist_group_1750
eststo: ratio dist_group_1750/dist_group_2000
eststo: ratio dist_group_2000/dist_group_2250
eststo: ratio dist_group_2250/dist_group_2500
esttab using ratios_table.rtf, replace
...
replace dist_group_50 = CallxArea if near_dist <= 50
replace dist_group_100 = CallxArea if (near_dist <= 100 & near_dist >50)
replace dist_group_250 = CallxArea if (near_dist <= 250 & near_dist >100)
replace dist_group_500 = CallxArea if (near_dist <= 500 & near_dist >250)
replace dist_group_750 = CallxArea if (near_dist <= 750 & near_dist >500)
replace dist_group_1000 = CallxArea if (near_dist <= 1000 & near_dist >750)
replace dist_group_1250 = CallxArea if (near_dist <= 1250 & near_dist >1000)
replace dist_group_1500 = CallxArea if (near_dist <= 1500 & near_dist >1250)
replace dist_group_1750 = CallxArea if (near_dist <= 1750 & near_dist >1500)
replace dist_group_2000 = CallxArea if (near_dist <= 2000 & near_dist >1750)
replace dist_group_2250 = CallxArea if (near_dist <= 2250 & near_dist >2000)
replace dist_group_2500 = CallxArea if (near_dist <= 2500 & near_dist >2250)
