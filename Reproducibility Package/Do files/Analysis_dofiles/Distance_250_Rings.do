...
log using "C:\Users\sgortizh\OneDrive - Syracuse University\EconResearch\course-project-zipcentercrime\Final Report\Reproducibility Package\Do files\Analysis_dofiles\Distance_Rings_250.log", replace
...
*** Export Graph
graph export "Visual Graphics\250_CI_Graph.png", replace
