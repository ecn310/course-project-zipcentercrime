...
esttab matrix(Summary_Results) using "Final Report\Reproducibility Package\Visual Graphics\New_Call_Summary_Stats.tex", replace
...
file open t_tests_file using "Final Report\Reproducibility Package\Visual Graphics\t_tests_results.tex", write replace
