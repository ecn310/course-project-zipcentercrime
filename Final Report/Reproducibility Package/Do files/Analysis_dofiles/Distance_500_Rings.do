...
log using "C:\Users\sgortizh\OneDrive - Syracuse University\EconResearch\course-project-zipcentercrime\Final Report\Reproducibility Package\Do files\Analysis_dofiles\FourRingDistances.log", replace
...
*** Export Graph
graph export "Visual Graphics\2CI_Graph.png", replace name(MyGraph)
...
* Now, craete the tex file we will put the t-tests in 
file open t_tests_four using "4_t_tests_results.tex", write replace
file write t_tests_four "\begin{table}[htbp]" _n
file write t_tests_four "\centering" _n
file write t_tests_four "\begin{tabular}{l|c c c c}" _n
file write t_tests_four "\hline" _n
...
foreach row of local rownames {
	...
	local diff  = string(el(t_tests, `i', 3), "%9.1f")
	local pval  = string(el(t_tests, `i', 4), "%9.3f")
<<<<<<<< HEAD:Final Report/Reproducibility Package/Do files/Analysis_dofiles/ReviewWithLessCalls.do
...
file write t_tests_file "\caption{\textbf{One-sample T-test Results by Distance Rings}}" _n
...
file write t_tests_four "\end{table}" _n
file close t_tests_four
>>>>>>>> 0de868d075ca457999c963f27a0664b5dde69f71:Final Report/Reproducibility Package/Do files/Analysis_dofiles/LessDistRings.do
...
log close
>>>>>>>> 0de868d075ca457999c963f27a0664b5dde69f71:Final Report/Reproducibility Package/Do files/Analysis_dofiles/LessDistRings.do
>>>>>>> 0de868d075ca457999c963f27a0664b5dde69f71
